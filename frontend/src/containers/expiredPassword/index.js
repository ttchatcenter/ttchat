...
const NewPassword = () => {
  ...
  return (
    <div className={wrapperClass}>
      <div className="bg-[url('/images/bg-curve-3.png')] bg-cover bg-center min-h-screen flex items-center justify-center">
        <div className={`flex flex-col bg-main-white ${isSuccess ? 'px-10 py-12' : 'px-14 py-12'} rounded-xl shadow-[0px_4px_4px_0px_#00000040]`}>
          {
            isSuccess ? (
              ...
              <>
                ...
                <h3 className="typo-hl1 text-base-grey6">Password Expired</h3>
                <h5 className="typo-th-shl3 text-accent-grey pt-2 pb-5">กรุณาตั้งรหัสผ่านใหม่เนื่องจากรหัสเก่าหมดอายุ</h5>
                <Form
                  labelCol={{ span: 8 }}
                  wrapperCol={{ span: 16 }}
                  layout="horizontal"
